...
export const LOCALE_REGISTRY = {
  ...
  en: { code: "en", name: "English", dir: "ltr", registered: true, translationStatus: "MISSING", editoriallyApproved: false, publiclyAvailable: false, routePrefix: "en", fallback: "fr" },
