...
export const LOCALE_REGISTRY = {
  ...
  en: { code: "en", name: "English", dir: "ltr", registered: true, domainStatuses: { ...missingDomainStatuses, global: "REVIEWED" }, editoriallyApproved: false, publiclyAvailable: false, routePrefix: "en", fallback: "fr" },
