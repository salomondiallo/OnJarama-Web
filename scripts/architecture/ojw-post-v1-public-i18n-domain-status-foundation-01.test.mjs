...
assert.match(types, /type TranslationStatus = "MISSING" \| "PARTIAL" \| "DRAFT" \| "REVIEWED" \| "APPROVED" \| "CANONICAL_APPROVED"/);
...
assert.match(config, /statuses\.some\(\(status\) => status === "MISSING" \|\| status === "PARTIAL" \|\| status === "DRAFT"\)\) return "PARTIAL"/);
...
assert.match(config, /status === "DRAFT" \|\| status === "REVIEWED" \|\| status === "APPROVED" \|\| status === "CANONICAL_APPROVED"/);
assert.match(config, /status === "REVIEWED" \|\| status === "APPROVED" \|\| status === "CANONICAL_APPROVED"/);
