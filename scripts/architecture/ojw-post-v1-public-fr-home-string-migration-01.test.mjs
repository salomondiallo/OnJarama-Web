...
assert.match(read("src/i18n/config.ts"), /en:.*domainStatuses: \{ \.\.\.missingDomainStatuses, global: "REVIEWED", home: "REVIEWED" \}.*editoriallyApproved: false.*publiclyAvailable: false/);
