...
const home = read("src/i18n/locales/fr/home.ts");
...
assert.match(section, /home\.ecosystem\.applications\.title/);
assert.match(home, /title: "Nos applications"/);
...
assert.match(section, /home\.ecosystem\.software\.title/);
assert.match(home, /title: "Nos logiciels"/);
